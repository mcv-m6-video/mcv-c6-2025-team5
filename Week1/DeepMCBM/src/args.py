...
def get_argparser():
    ...
    parser.add_argument("--STN_total_epochs", type=int, default=350) #350. 7000
    ...
    # for forward pass
    parser.add_argument("--train_homography_epoch", type=int, default=int(350 *3 / 7)) #350 *3 / 7 , 3000

    # STN ckpt args
    parser.add_argument("--STN_ckpt_dir", type=str, default=CKPT_DIR)
    parser.add_argument("--STN_ckpt", type=str, default="frames_vdo_train25_my_run_STN_best.ckpt")
    ...
    parser.add_argument("--AE_total_epochs", type=int, default=int(350 *2 / 7)) #2000
    ...
    parser.add_argument("--BMN_ckpt", default="frames_vdo_train25_my_run_BMN_best.ckpt", type=str)
