...
def get_datasets(args):
    ...
    val_extra_data = ActionSpotVideoDataset(classes, os.path.join('data', args.dataset, 'val.json'),
        args.frame_dir, args.clip_len, **dataset_kwargs)
    val_extra_data.print_info()
        
    return classes, train_data, val_data, test_data, val_extra_data